...
urls <-to_list(for (val in unlist(recursos_CB['Link al recurso'])) 
  if (is.na(val)) 'Pronto colocaremos la URL' else paste("<a href=javascript:window.open('http://norfipc.com/','','width=600,height=400,left=50,top=50,toolbar=yes');void 0>","Ir al recurso","</a>"))
